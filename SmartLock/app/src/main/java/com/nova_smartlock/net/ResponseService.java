...
//        params.put("password", DigitUtil.getMD5(password));
    ...
    public static String sign_up(String username, String password) {
        String url = actionUrl + "/v3/user/register";
    ...
    public static String uploadLockName(String name, String token, String lockId) {
        String url = actionUrl + "/v3/lock/rename";
        Map params = new LinkedHashMap();
        params.put("clientId", Config.CLIENT_ID);
        params.put("accessToken", token);
        params.put("lockId", lockId);
        params.put("lockAlias", name);
        params.put("date", String.valueOf(System.currentTimeMillis()));
        return OkHttpRequest.get(url, params);
    }

    public static String lockDetails(String token, String lockId) {
        String url = actionUrl + "/v3/lock/detail";
        Map params = new LinkedHashMap();
        params.put("clientId", Config.CLIENT_ID);
        params.put("accessToken", token);
        params.put("lockId", lockId);
     ...
     * @return
     */
    public static String sendEKey(Key key, String receiverUsername, long start_time, long end_time) {
        ...
        params.put("startDate", String.valueOf(start_time));
        params.put("endDate", String.valueOf(end_time));
    ...
    public static String syncData(long lastUpdateDate) {
        ...
        String toekn = MyPreference.getStr(SmartLockApp.mContext, MyPreference.ACCESS_TOKEN);
        HashMap params = new HashMap();
        params.put("clientId", Config.CLIENT_ID);
    ...
    public static String getRecordLog(int lockId, long start_time, long end_time, String page_number, String page_size) {
        String url = actionUrlV3 + "/lockRecord/list";
        HashMap params = new HashMap();
        params.put("clientId", Config.CLIENT_ID);
        params.put("accessToken", MyPreference.getStr(SmartLockApp.mContext, MyPreference.ACCESS_TOKEN));
        params.put("lockId", String.valueOf(lockId));
        params.put("startDate", String.valueOf(start_time));
        params.put("endDate", String.valueOf(end_time));
        params.put("pageNo", String.valueOf(page_number));
